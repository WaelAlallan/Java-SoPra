...
/**
 * Klasse zum erstellen des GUI-Fensters Studie Filtern der Study Nurse
 * 
 * @author Sebastian Huck
 */
public class StudienFilternStudyNurseFormular {
	 ...
	 */
	public StudienFilternStudyNurseFormular(Stage stage, Scene oldScene) {
	...
	private void beobachten() {
		...
		buttons.getButton("Filtern").setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				ArrayList<Studie> studien = ses.getStudien(sltf.getTextField("Name:").getText(),
						sltf.getTextField("Anzahl Teilnehmer:").getText());
