 ...
 */
public class RaumHinzufuegenController {
	 ...
	 */
	public EventHandler<ActionEvent> getActionForBestaetigenButton(Stage stage, Scene scene,
		...
		return new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				try {
					rs.raumHinzufuegen(name, standort, temp);
