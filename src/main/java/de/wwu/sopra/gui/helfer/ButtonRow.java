...
/**
 * Klasse, die eine Reihe aus Buttons automatisch erstellt.
 * 
...
public class ButtonRow {
	...
	/**
	 * Erstellt eine Reihe aus Buttons, in denen die Buttons mit gleicher Breite
	 * verteilt sind.
	 * 
	 * @param labels Array aus Strings, welche den Text in den gewuenschten Buttons
	 *               darstellen.
	 */
	public ButtonRow(String[] labels) {
		int n = labels.length;
