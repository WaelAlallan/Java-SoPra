...
import de.wwu.sopra.controller.biobankleitercontroller.behaeltertypverwaltungcontroller.BehaeltertypHinzufuegenController;
...
/**
 * GUI Klasse zum erstellen des GUI Fensters Behaeltertyp hinzufuegen
 * 
 * @author Alexander Leifhelm, Sebastian Huck, Wael Al Allan
 */
public class BehaeltertypHinzufuegenFormular {
	private Stage stage;
	 ...
	 */
	public BehaeltertypHinzufuegenFormular(Stage stage, Scene oldScene) {
		this.stage = stage;
	 ...
	 */
	private void init() {
		kopfUUB = new UeberschriftUndButton("Behaeltertyp hinzuf\u00FCgen", "Hauptmen\u00FC", null);
	...
	private void beobachteAktionen() {
		BehaeltertypHinzufuegenController controller = new BehaeltertypHinzufuegenController();
		...
		buttonsBR.getButton("Hinzuf\u00FCgen")
				.setOnAction(controller.getActionForHinzufuegenButton(stage, oldScene, eingabenSLTF));
	}
