 ...
 */
public class BehaeltertypFilternController {
	...
	public EventHandler<ActionEvent> getActionForFilternButton(Stage stage, Scene scene,
		...
		return new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				ArrayList<ProbenBehaelterTyp> behaelterTypenAL = pbhs.getProbenbehaeltertyp(name, volumen, hoehe,
						durchmesser, deckelTyp);
